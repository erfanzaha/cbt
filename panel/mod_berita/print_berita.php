	...
	<table border='0' width='100%'>
		<tr>
			...
			<td rowspan='4' style="width:'120'; text-align:center">
				<img src='../../foto/ib_logo.png' width='80'>
			</td>
	...
	<div class="footer">
		<table width="100%" height="30">
			<tr>
				...
				<td width="5px">&nbsp;</td>
				<td style="border:1px solid black;font-weight:bold;font-size:14px;text-align:center;">KEMENTERIAN AGAMA REPUBLIK INDONESIA</td>
				<td width="5px">&nbsp;</td>
				<td width="25px" style="border:1px solid black"></td>
			</tr>
		</table>
